...
using Tripaui.Resources.Styles;
    ...
    internal class SimpleRatingControl : HorizontalStackLayout
    {
        ...
        private Label CreateStarLabel(StarState state)
        {
            return new Label
            {
                ...
                Text = state switch
                {
                    StarState.Empty => MdIconFont.StarOutline,
                    StarState.Half => MdIconFont.StarHalfFull,
                    StarState.Full => MdIconFont.Star,
                    _ => MdIconFont.StarOutline,
                }
            };
        }
